...
public class CannonView extends SurfaceView implements
   ...
   public void drawGameElements(Canvas canvas) {
      ...
      canvas.drawLine(40, screenHeight / 2 + 10, barrelEnd.x + 20, barrelEnd.y + 10, cannonPaint);
      canvas.drawLine(40, screenHeight / 2 - 40, barrelEnd.x + 20, barrelEnd.y - 40, cannonPaint);
      //canvas.drawLine(barrelEnd.x + 20, barrelEnd.y + 10, barrelEnd.x + 20, barrelEnd.y - 40, cannonPaint);

      cannonPaint.setStrokeWidth(lineWidth * 0.1f);
      cannonPaint.setColor(Color.BLACK);
      /*
      canvas.drawLine(0, screenHeight/2 - lineWidth*1.5f, barrelEnd.x, barrelEnd.y, cannonPaint);
      canvas.drawLine(0, screenHeight/2 + lineWidth*1.5f, barrelEnd.x, barrelEnd.y, cannonPaint);
      */
      ...
      blockerPaint.setStrokeWidth(lineWidth * 0.1f);
      canvas.drawLine(blocker.start.x, blocker.start.y, blocker.end.x, blocker.end.y, blockerPaint);
      canvas.drawLine(blocker.start.x + 30, blocker.start.y, blocker.end.x + 30, blocker.end.y, blockerPaint);
      canvas.drawLine(blocker.start.x, blocker.start.y, blocker.start.x + 30, blocker.start.y, blockerPaint);
      canvas.drawLine(blocker.start.x, blocker.end.y, blocker.start.x + 30, blocker.end.y, blockerPaint);
      ...
      for (int i = 1; i <= TARGET_PIECES; ++i) {
         ...
         if (!hitStates[i - 1]) {
            ...
            canvas.drawLine(currentPoint.x, currentPoint.y, target.end.x, (int) (currentPoint.y + pieceLength), targetPaint);
            canvas.drawLine(currentPoint.x + 25, currentPoint.y, target.end.x + 25, (int) (currentPoint.y + pieceLength), targetPaint);
            canvas.drawLine(currentPoint.x, currentPoint.y, target.end.x + 25, currentPoint.y, targetPaint);
            canvas.drawLine(currentPoint.x, (int) (currentPoint.y + pieceLength), target.end.x + 25, (int) (currentPoint.y + pieceLength), targetPaint);
         } // end if
